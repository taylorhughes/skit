...
function renderError(res, e, opt_message, opt_code) {
  ...
  var excerptHtml;
  if (e && e.fileName && typeof e.lineNumber == 'number') {
    var fileContent = '<unknown file>';
    try {
      fileContent = fs.readFileSync(e.fileName).toString();
    } catch (e) {
    ...
    var relevantLines = lines.slice(Math.max(0, e.lineNumber - 5), e.lineNumber + 5);
