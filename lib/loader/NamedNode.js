...
NamedNode.prototype.findNodeWithPath = function(string, opt_separator) {
  ...
  return this.findNodeWithPathComponents(components);
};


NamedNode.prototype.findNodeWithPathComponents = function(components) {
  var current = this;
...
NamedNode.prototype.eachChild = function(fn, opt_context) {
  for (var n in this.children_) {
    fn.call(opt_context, this.children_[n]);
  }
};
