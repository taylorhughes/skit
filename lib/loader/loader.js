...
function loadResourcesForModule(module, opt_cssOnly) {
  var allResources = module.__allResources__;
  if (!allResources) {
    allResources = module.__allResources__ = module.buildResourceList();
  }
  var cssResources = [];
  var scriptResources = [];
...
function loadAllCssResourcesInModule(root) {
  var allCss = [];
  root.children().forEach(function(child) {
    if (child.buildResourceList) {
      ...
      allCss = allCss.concat(loadAllCssResourcesInModule(child));
    }
  });
  return allCss;
}
module.exports.loadAllCssResourcesInModule = loadAllCssResourcesInModule;
