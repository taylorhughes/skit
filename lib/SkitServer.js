...
function SkitServer(packagePath, opt_options) {
  ...
  this.publicRootName = options.publicRoot || 'public';
...
SkitServer.prototype.getPublicRoot = function() {
  return this.root().getChildWithName(this.publicRootName);
};
...
SkitServer.prototype.controllerAtUrl = function(url) {
  ...
  var namedArguments = {};
  var currentNode = this.getPublicRoot();
...
SkitServer.prototype.globalCssResources = function() {
  ...
  return loader.loadOptimizableCssResourcesInRoot(publicRoot);
};
