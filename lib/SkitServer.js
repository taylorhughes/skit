...
var ModuleLoader = require('./loader/ModuleLoader');
...
SkitServer.prototype.serveController = function(req, res) {
  ...
  var loadNextInner_ = function() {
    ...
    var bundles = self.loader.bundlesRequiredForModule(module);

    var controllerRenderer = new ControllerRenderer(moduleLoader, bundles, self, {
      url: req.url,
